				...
				<div class="col-md-9">
					<div class="row mr-3">
						<div class="embed-responsive embed-responsive-16by9">
							<iframe width="560" height="315" src="https://www.youtube.com/embed/6jiNS_4CEug"
								frameborder="0"
						...
						<div class="col-12 mt-5">
							<div class="row">
								<p>
									...
									<br><br>
									There are many of passages of Lorem Ipsum available, but the majority have suffered
									alteration in some form, by injected humour, or randomised words which don't look
									even . If you are going to use a passage of Lorem Ipsum, you need to be sure there
