...
<?php require('header.php');?>
	...
	<div class="container">
		<div class="row pt-5">
            <?php
            $response = RestApi::getFromYous($_GET['nextpage']);
				...
				<div class="pb-3 col-md-4">
						...
						<div class="col-12 mt-1">
							<h6 class="font-weight-bold">
								<a href="/fromyoudetails.php?id=<?=$videoSnippet['resourceId']['videoId']?>" class="text-decoration-none text-dark">
            ...
            <div class="col-md-12 row mt-3 text-center">
                ...
                if($_GET['nextpage']!=null){?>
                    <div class="col-md-2 text-center mt-3">
                        <a href="/fromyou.php?nextpage=<?=$prevPageToken?>" class="btn btn-warning">
                            ÖNCEKİ SAYFA
                        </a>
                    </div>
                <?php } ?>
                ...
                ?>
                <div class="col-md-2 text-center mt-3">
                    <a href="/fromyou.php?nextpage=<?=$nextPageToken?>" class="btn btn-warning">
                        SONRAKİ SAYFA
                    </a>
