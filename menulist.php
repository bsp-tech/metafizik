<ul class="list-unstyled text-light mt-2">
                    ...
                    <li class="d-inline-block border border-light rounded-pill mt-2  ml-2  px-3 py-1"><a
                            href="/articles.php" class="text-decoration-none text-white">Makaleler</a></li>
                    <li class="d-inline-block border border-light rounded-pill mt-2  ml-2  px-3 py-1"><a
                            href="/services.php" class="text-decoration-none text-white">Hizmetlerimiz</a></li>
<!--                    <li class="d-inline-block border border-light rounded-pill mt-2  ml-2  px-3 py-1"><a-->
<!--                            href="/fromyou.php" class="text-decoration-none text-white">Hastalarımızın Dilinden</a></li>        -->
<!--                    <li class="d-inline-block border border-light rounded-pill mt-2  ml-2  px-3 py-1"><a-->
<!--                            href="/media.php" class="text-decoration-none text-white">Basında Biz</a></li>-->
                    <li class="d-inline-block ml-2 ">
                        <div class="btn-group">
                            ...
                            <div style="opacity: 0.9;" class="mt-2 dropdown-menu dropdown-menu-right">
                                <a href="/fromyou.html" class="dropdown-item text-decoration-none ">Hastalarımızın Dilinden</a>
                                <a href="/media.html" class="dropdown-item text-decoration-none">Basında biz</a>
                    ...
                    <li class="d-inline-block border border-light rounded-pill mt-2  ml-2    px-3 py-1"><a
                            href="/about.php" class="text-decoration-none text-white">Hakkında</a></li>
                     <li class="d-inline-block border border-light rounded-pill mt-2  ml-2    px-3 py-1"><a
                            href="/contact.php" class="text-decoration-none text-white">İletişim</a></li>
